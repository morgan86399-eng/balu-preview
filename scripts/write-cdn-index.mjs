...
const MEDIA_COMMIT = process.env.CDN_COMMIT || "b1dd6335b1fd3027d1e4a14be934ae100fe0b341";
const CACHE_BUST = "n13fix1";
...
<html lang="zh-Hant-TW">
  <head>
    ...
    <title>八路列傳</title>
    <!-- N13: pin public/ + JS/CSS to one commit; ?v=${CACHE_BUST} -->
